...
public class Coin {
	...
	public static float RADIUS2 = 0.0025f;
	public float mX, mY;
	
Coin(float x, float y, Context c){
		mX = x;
		mY = y;
		mContext=c;
		setupCoin();
	...
	public void setupCoin(){
				...
				int id = mContext.getResources().getIdentifier("drawable/coin", null, mContext.getPackageName());
